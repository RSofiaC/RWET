...
print "DONE Expected output: helium"
...
print "DONE Expected output: lithium"
...
student_names = student_ages.keys() # <-- Asking to access the keys in the Dict
print len(student_names)#<-- once I know that variable are the keys give me len

#------------------------------------------------------------------------

print "\n------"
print "Task 5: Dictionary operations"
print "DONE Expected output: Pluto is not a planet."
...
planet_name = 'Home'#<-- It was just a matter of picking anything not in the dic
...
planet_list = [planet_classifications] # <-- change this
for planet in planet_list:
	if planet.value('terrestrial')
